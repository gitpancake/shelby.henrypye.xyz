...
export async function extractServiceRecords(
  ...
  const content: Anthropic.Messages.ContentBlockParam[] = [
    ...
    {
      type: "text",
      text: "Extract all service records from this document. Return only JSON.",
    },
  ];
